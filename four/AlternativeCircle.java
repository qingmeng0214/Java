public class AlternativeCircle {
	public static void main(String[] args) {
		...
		System.out.println("The area of the ciecle of radius "+circle1.radius +" is "+circle1.getArea());
		AlternativeCircle circle2 = new AlternativeCircle(25);
		System.out.println("The area of the ciecle of radius "+circle2.radius +" is "+circle2.getArea());
